...
public class GroovyExecutor2 {
    private ScriptEngine scriptEngine;
    private static GroovyExecutor2 groovyExecutor = new GroovyExecutor2();

    public static GroovyExecutor2 getInstance() {
        return groovyExecutor;
    }

    private GroovyExecutor2() {
    }
